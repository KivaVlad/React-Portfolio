                    ...
                    <div className="home_left_section_container">
                        ...
                        <div className="home_left_section_main">
                            ...
                            <p className="home_subtitle">
                                 Добро пожаловать в мой сайт портфолио. У меня для вас отличная новость! Вы нашли человека, который сможет реализовать огромный спектр задач, связанных с разработкой и настройкой лендингов, интернет магазинов и других сайтов.
                             </p>
                            <button className="home_button">Мои проекты</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="home_right_section_container">
                        <div className="home_right_section_header">
                            <div className="home_right_section_header_nav">
                                ...
                                <NavLink to="" className="home_right_section_header_link">Проекты</NavLink>
