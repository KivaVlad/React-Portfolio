                ...
                <div className="home_left_section">
                    <div className="home_left_section_container">
                        ...
                        <div className="home_left_section_main">
                            ...
                            <p className="home_subtitle">Добро пожаловать в мой сайт портфолио. У меня для вас отличная новость! Вы нашли человека, который сможет реализовать огромный спектр задач, связанных с разработкой и настройкой лендингов, интернет магазинов и других сайтов.</p>
